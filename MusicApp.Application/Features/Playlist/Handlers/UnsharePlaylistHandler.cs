...
public class UnsharePlaylistCommandHandler : IRequestHandler<UnsharePlaylistCommand, Unit>
{
    ...
    public UnsharePlaylistCommandHandler(
    ...
    public async Task<Unit> Handle(UnsharePlaylistCommand request, CancellationToken cancellationToken)
    {
        ...
        string playlistName = await _playlistShareRepository.DeactivateShareAsync(
            request.PlaylistId,
            request.OwnerUserId,
